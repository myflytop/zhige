...
import com.ruoyi.common.enums.ValueEnum;
...
public interface PropertyEnum extends ValueEnum<String> {
    ...
    static <T> T convertTo(@NonNull String value, @NonNull Class<T> type) {
        ...
        throw new UnsupportedOperationException(
                "Unsupported convention for web property type:" + type.getName() + " provided");
    }
    ...
    /**
     * Check the type is support by the web property.
     *
    ...
    static boolean isSupportedType(Class<?> type) {
        ...
        return type.isAssignableFrom(String.class) || type.isAssignableFrom(Number.class)
                || type.isAssignableFrom(Integer.class) || type.isAssignableFrom(Long.class)
                || type.isAssignableFrom(Boolean.class) || type.isAssignableFrom(Short.class)
                || type.isAssignableFrom(Byte.class) || type.isAssignableFrom(Double.class)
                || type.isAssignableFrom(Float.class) || type.isAssignableFrom(Enum.class)
