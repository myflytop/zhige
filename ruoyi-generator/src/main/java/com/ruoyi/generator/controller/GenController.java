...
public class GenController extends BaseController {
     ...
     */
    @RequiresPermissions("tool:gen:list")
    @Log(title = OperateTitle.SYS_GEN, businessType = BusinessType.IMPORT)
     ...
     */
    @RequiresPermissions("tool:gen:edit")
    @Log(title = OperateTitle.SYS_GEN, businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
    ...
    @Log(title = OperateTitle.SYS_GEN, businessType = BusinessType.DELETE)
    @PostMapping("/remove")
    @ResponseBody
    ...
    @RequiresRoles("admin")
    @Log(title = OperateTitle.SYS_TABLE, businessType = BusinessType.INSERT)
    ...
    @Log(title = OperateTitle.SYS_GEN, businessType = BusinessType.GENCODE)
