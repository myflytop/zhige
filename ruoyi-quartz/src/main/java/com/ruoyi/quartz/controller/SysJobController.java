...
public class SysJobController extends BaseController {
    ...
    @Log(title = OperateTitle.SYS_QUARTZ, businessType = BusinessType.EXPORT)
    ...
    @Log(title = OperateTitle.SYS_QUARTZ, businessType = BusinessType.DELETE)
     ...
     * 任务调度状态修改
     */
    @Log(title = OperateTitle.SYS_QUARTZ, businessType = BusinessType.UPDATE)
     ...
     * 新增保存调度
     */
    @Log(title = OperateTitle.SYS_QUARTZ, businessType = BusinessType.INSERT)
