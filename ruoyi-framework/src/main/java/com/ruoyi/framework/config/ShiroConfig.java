...
public class ShiroConfig {
    ...
    public EhCacheManager ehCacheManager(CacheManager cacheManager) {
        cacheManager = CacheManager.getCacheManager("ruoyi");
     ...
     */
    @Bean
    public OnlineWebSessionManager sessionManager(EhCacheManager ehCacheManager) {
    ...
    public ShiroFilterFactoryBean shiroFilterFactoryBean(SecurityManager securityManager,
        ...
        filterChainDefinitionMap.put("/demo/**", "user,kickout,onlineSession,syncOnlineSession");
        filterChainDefinitionMap.put("/druid/**", "user,kickout,onlineSession,syncOnlineSession");
        // 文件下载匿名访问
        ...
        filters.put("kickout", kickoutSessionFilter(ehCacheManager));
        // 注销成功，则跳转到指定页面
     ...
     * 同一个用户多设备登录限制
     */
    public KickoutSessionFilter kickoutSessionFilter(EhCacheManager ehCacheManager) {
        KickoutSessionFilter kickoutSessionFilter = new KickoutSessionFilter();
        kickoutSessionFilter.setCacheManager(ehCacheManager);
        kickoutSessionFilter.setSessionManager(sessionManager(ehCacheManager));
