...
public class SysUserController extends BaseController {
    ...
    @Log(title = OperateTitle.SYS_USER, businessType = BusinessType.EXPORT)
    ...
    @Log(title = OperateTitle.SYS_USER, businessType = BusinessType.IMPORT)
    ...
    @Log(title = OperateTitle.SYS_USER, businessType = BusinessType.INSERT)
    @PostMapping("/add")
    @ResponseBody
     ...
     */
    @RequiresPermissions("system:user:edit")
    @Log(title = OperateTitle.SYS_USER, businessType = BusinessType.UPDATE)
    @PostMapping("/edit")
    @ResponseBody
     ...
     */
    @RequiresPermissions("system:user:edit")
    @Log(title = OperateTitle.SYS_USER, businessType = BusinessType.GRANT)
    ...
    @Log(title = OperateTitle.SYS_USER, businessType = BusinessType.DELETE)
    @PostMapping("/remove")
    @ResponseBody
