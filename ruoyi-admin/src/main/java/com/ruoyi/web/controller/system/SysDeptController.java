...
public class SysDeptController extends BaseController {
     ...
     * 新增保存部门
     */
    @Log(title = OperateTitle.SYS_DEPT, businessType = BusinessType.INSERT)
     ...
     * 修改保存部门
     */
    @Log(title = OperateTitle.SYS_DEPT, businessType = BusinessType.UPDATE)
    @RequiresPermissions("system:dept:edit")
    @PostMapping("/edit")
    @ResponseBody
     ...
     * 删除
     */
    @Log(title = OperateTitle.SYS_DEPT, businessType = BusinessType.DELETE)
