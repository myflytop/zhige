package com.ruoyi.cache.redis.aspect;

import com.ruoyi.cache.redis.annotation.RedisCache;
import com.ruoyi.cache.redis.annotation.RedisEvict;
...
public class RedisAspect
{
     ...
     */
    @Pointcut("@annotation(com.ruoyi.cache.redis.annotation.RedisCache)")
    public void redisCachePoint()
    {
    }

    @Pointcut("@annotation(com.ruoyi.cache.redis.annotation.RedisEvict)")
