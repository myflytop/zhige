package com.oly.cms.general.aspect;
...
public class WebLogAspect {
    ...
    // 配置织入点
    @Pointcut("@annotation(com.oly.cms.general.annotation.WebLog)")
    ...
    protected void handleLog(final JoinPoint joinPoint, final Exception e, Object jsonResult) {
        try {
            // 获得注解
            WebLog controllerLog = getAnnotationLog(joinPoint);
            ...
            // 保存数据库
            GeneralAsyncManager.me().execute(WebAsyncFactory.recordOper(operLog));
        } catch (Exception exp) {
            // 记录本地异常日志
            log.error("==前置通知异常==");
