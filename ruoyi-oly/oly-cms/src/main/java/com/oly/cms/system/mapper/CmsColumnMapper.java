...
public interface CmsColumnMapper {
	 ...
	 * @return
	 */
	int checkColumnNameUnique(@Param("parentId") Long parentId, @Param("columnName") String columnName,
	...
	int updateTagVisible(@Param("columnId") Long columnId, @Param("visible") Integer visible);
}
