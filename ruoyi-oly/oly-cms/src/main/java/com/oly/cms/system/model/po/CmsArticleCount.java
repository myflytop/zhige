...
public class CmsArticleCount extends BaseEntity {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("articleId", getArticleId())
                .append("articleLook", getArticleLook()).append("articleLike", getArticleLike())
                .append("articleNasty", getArticleNasty()).append("articleDiscuss", getArticleDiscuss())
                .append("articleScore", getArticleScore()).append("articleShare", getArticleShare())
                .append("articleCollect", getArticleCollect()).toString();
    }
}
