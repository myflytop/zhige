...
import com.oly.cms.system.service.ICmsContactService;
...
public class CmsContactController extends CmsCommonController {
    private String prefix = acceptPreifx + "contact";
    ...
    public AjaxResult addSave(CmsContact cmsContact) {
        cmsContact.setCreateBy(ShiroUtils.getUserId());
    ...
    public AjaxResult editSave(CmsContact cmsContact) {
        cmsContact.setHandler(ShiroUtils.getUserId());
