...
public class BaseTheme implements Serializable {
    ...
    public String toString() {
        return "CmsTheme{" + "themeId=" + themeId + ", themeName='" + themeName + '\'' + ", themeAuthor='" + themeAuthor
                + '\'' + ", themeUpdate='" + themeUpdate + '\'' + ", createTime=" + createTime + ", themeInfo='"
                + themeInfo + '\'' + ", themeVersion='" + themeVersion + '\'' + ", themeEnabled=" + themeEnabled
                + ", themeTouch='" + themeTouch + '\'' + ", createBy=" + createBy + ", folder=" + folder + '}';
    }
}