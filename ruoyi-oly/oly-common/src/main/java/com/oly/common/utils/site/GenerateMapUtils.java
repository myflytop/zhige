...
public class GenerateMapUtils {
     ...
     * @param themeName
     */
   public static void generateBaiDuMap(String tempPath,String domain,Map<String,List<String>> maps,String themeName ){
    ...
    SitemapIndexGenerator sitemapIndexGenerator = new SitemapIndexGenerator
            .Options(domain, new File(tempPath+"/"+themeName+"SiteMapIndex.xml"))
