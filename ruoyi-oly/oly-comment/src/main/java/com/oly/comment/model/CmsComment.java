...
public class CmsComment implements Serializable {
    ...
    public String toString() {
        return new ToStringBuilder(this, ToStringStyle.MULTI_LINE_STYLE).append("commentId", getCommentId())
                .append("articleId", getArticleId()).append("parentId", getParentId())
                .append("createTime", getCreateTime()).append("fromBy", getFromBy()).append("replyBy", getReplyBy())
                .append("content", getContent()).append("commentType", getCommentType()).append("visible", grtVisible())
                .append("ip", getIp()).append("userSystem", getUserSystem()).append("userBower", getUserBower())
                .append("nastyCount", getNastyCount()).append("likeCount", getLikeCount()).append("remark", getRemark())
                .toString();
    }
}
