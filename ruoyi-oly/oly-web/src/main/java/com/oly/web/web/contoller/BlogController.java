...
public class BlogController extends CommonController {
    ...
    @GetMapping("/search")
    public String search(ModelMap mp,BlogArticleSearchParam parm){
     ...
     */
    @GetMapping("/timeLine")
    public String timeLine(ModelMap modelMap, @RequestParam(defaultValue = "1") int pageNum,@RequestParam(defaultValue = "20") int pageSize) {
