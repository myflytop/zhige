...
public class BlogConfigCacheService {
    ...
    @Cacheable(value = CacheConstant.CONFIG_CACHE_KEY_PREFIX, key = "methodName+'_'+#p0")
    public Map<String, String> getWebConfigByGroup(String group) {

        return bService.selectConfigValueMap(group);
    }

    @Cacheable(value = CacheConstant.CONFIG_CACHE_KEY_PREFIX, key = "methodName+'_'+#p0+'_'+#p1")
